            ...
            <div class="container">
                ...
                <div class="wrap-slick2" style="display: flex; flex-flow: row wrap; ">
                    <?php 
                        ...
                        $queryString = "
                            select * 
                            from borrowed_record bir INNER JOIN (SELECT e.entry_id, e.name, e.image_path, e.location
                            FROM entry e ) as e
                            ON bir.entry_id = e.entry_id
                            WHERE bir.borrower_id = $_SESSION[user_id]
                            and ( bir.owner_received = false OR bir.borrower_returned = false);
                        ";
                                            ...
                                            <div style='margin-left: auto; border: 1px solid #e8e8e8; border-radius: 8px; padding: 8px'>
                                                ...
                                                <div class='flex-col w-90'>
                                                    <div style='width: 100%; display: flex'>
                                                        ...
                                                        <form action='../logic/borrower-confirm-return.php?record_id=$oneRecord[record_id]' method='POST' style='width: 50%; flex-direction: column; display:flex'>
                                                            ...
                                                            if($oneRecord['borrower_returned'] == 't'){
                                                                echo"
