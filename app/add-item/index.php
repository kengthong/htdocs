                ...
                <?php   
                    if(isset($_SESSION['name'])) {
                        ...
                        echo"
                            <div>
                                <button id='login' 
                                    style='border-radius:8px; padding: 4px; font-size: 12px; width: 80px;'>
                            ...
                            <script>
                                ...
                                loginButton.addEventListener('click', function() {
                                    document.location.href=baseUrl + 'app/login/index.php';
                                })
                            </script>
                        ";
                    }
                ...
                <?php 
                    if(isset($_SESSION['user_id'])) {
                        ...
                        <div class='row align-items-center'>
                            <form class='row col-12' action='add-item.php' method='POST'>
                                <div class='col-6'>
                                        ...
                                        <div class='form-group'>
                                            ...
                                            <small class='form-text text-muted'> This will be the title of your post</small>
                                        </div>
                                ...
                                <div class='col-6'>
                                    <div class='form-group'>
                                        ...
                                        <input 
                                            ...
                                            class='form-control'
                                            placeholder='Address'>
                                        <small class='form-text text-muted'> Location to meet</small>
                                    </div>
                        ...
                        echo "
                            <div>
                                ...
                                <div>
                                    <a href='http://localhost:8080/app/login/index.php'>Click here</a>
                                </div>
                            </div>
                        ";
                    }
