...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="amado_product_area section-padding-100">
            <div class="container-fluid w-100" style='display: flex; align-items: center;'>  
                <div style='width: 100%; text-align: center; font-size: 24px; font-weight: 300;'>
                    Successfully entered bid
                </div> 
                <img 
                    style="height: 250px; width: 250px;"
                    src="https://tr2.cbsistatic.com/hub/i/2017/07/11/26db07b8-2d2c-41d2-bafd-0537611ed74f/ewordemojis.png" alt=''>
            </div>
        </div>
    </div>
