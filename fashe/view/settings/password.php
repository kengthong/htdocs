    ...
    <div class="container">
        <div class="page-body container">
            <section class="row settings-wrapper">
                <div class="col-md-3 col-sm-4" style='padding: 0px'>
                    <ul style='flex-direction: column; display: flex;'>
                        <li class="settings-type-row">
                            <a href="profile.php" class="F-g">
                                <b>Edit Profile</b>
                            </a>
                        </li>
                        <li class="settings-type-row" style='background: #fff;'>
                            <a href="password.php" class="F-g" style='font-size: 18px; color: #4b4d52; font-weight: 600;'>
                ...
                <div class="col-md-9 col-sm-8 F-h" style='background-color: white'>
                    <form autocomplete="off" class="cs-form F-i" action='../../logic/change-password.php' method='POST'>
                        ...
                        <div class="cs-form-section">   
                            <div class='settings-big-box'>
                                <div class="form-group cs-form-group">
                                    ...
                                    <input 
                                        type="password" autocapitalize="off" autocomplete="off" autocorrect="off" 
                        ...
                        <div style='width: 100%; justify-content: flex-end; display: flex; padding: 8px;'>
                            <button type="submit" name='change-password-submit'class="btn F-b btn-primary">
                                <span>Save</span>
                            </button>
                        </div>
                    </form>
        ...
        <?php
            ...
            if($query['changed'] == 'error'){
                echo "<script type='text/javascript'> alert('Make sure that the passwords entered are correct');</script>";
            }
        ?>
	<!-- Back to top -->
